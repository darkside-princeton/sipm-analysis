...
def main():
    ...
    d = wfd.WaveformDataset(path=args.file_dir, samples=4000, channels=np.arange(8), trig=1555)
    ...
    d.get_fprompt(tprompt=[0.3],channels=np.array([0,3,5,6]))
    ...
    # Save data to HDF5
    io.save(script='scintillation_pulse_liq6')
